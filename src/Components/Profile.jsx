  ...
  return (
    <div className="container1">
      <div className="section1">
        ...
        />
        <Link to="signIn"><div className="section1Txt">
          <p className="Txt">Sign in</p>
          <p className="Txt">for a better experience</p>
        </div>
        </Link>
      </div>
      <div className="section">
        <img
          className="logos"
          src="https://images.slivcdn.com/UI_icons/Subscribe_Now.png?h=22&w=22&t=c_fill&q=low&fr=webp"
        />
        <p className="Txt">Subscribe now</p>
      </div>
      <div className="section2">
        <img
          className="logos"
          src="https://images.slivcdn.com/UI_icons/New_Final_Icons_30052020/ActivateTV3x.png?h=22&w=22&t=c_fill&q=low&fr=webp"
        />
        <p className="Txt">Activate Tv</p>
      </div>
      <div className="section2">
        <img
          className="logos"
          src="https://images.slivcdn.com/UI_icons/New_Final_Icons_30052020/ActivateTV3x.png?h=22&w=22&t=c_fill&q=low&fr=webp"
        />
        <p className="Txt">Settings and preferences</p>
      </div>
      <div className="section2">
        <img
          className="logos"
          src="https://images.slivcdn.com/UI_icons/settings_icon.png?h=22&w=22&t=c_fill&q=low&fr=webp"
        />
      ...
      <div className="section2">
        <img
          className="logos"
          src="https://images.slivcdn.com/UI_icons/New_Final_Icons_30052020/WhatsApp_icon_2x.png?h=22&w=22&t=c_fill&q=low&fr=webp"
        />

        <p className="Txt">Chat with us on WhatsApp</p>
      </div>
      <div className="section2">
        <img
          className="logos"
          src="https://images-preprod.slivcdn.com/activate/offer.png?h=22&w=22&t=c_fill&q=low&fr=webp"
        />

        <p className="Txt">Activate Offer</p>
      </div>
    </div>
  );
}
